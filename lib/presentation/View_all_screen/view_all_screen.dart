import 'package:flash_delivery_app/widgets/custom_card_restaurant_viewall.dart';
...
class ViewAllScreen extends StatelessWidget {
  ...
  const ViewAllScreen({super.key,required this.restaurantList});
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: CustomCardRestaurantViewAll(
                    imageUrl: info.url ?? '',
                    title: info.title ?? '',
